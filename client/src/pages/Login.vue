    ...
    <div id="login-form-container">
      <div class="card">
        <div class="card-image">
          <figure class="image ">
            <img id="bg" src="https://res.cloudinary.com/ht3nqskad/image/upload/v1604808653/logo2.png"
...
#background-overlay {
  ...
  width: 100%;
  height: 100%;
  background-color: rgba(37, 69, 78, 0.56);
}
